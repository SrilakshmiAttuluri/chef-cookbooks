...
default['maven']['repositories'] = ['http://34.196.120.121:8081/nexus/content/repositories/snapshots']
default['maven']['setup_bin'] = true

#Attributes for download from Nexus Artifact

default[:maven][:group_id] = 'org.springframework.samples'
default[:maven][:app_name] = 'spring-petclinic'
#default[:maven][:nexus_url] = ['http://34.196.120.121:8081/nexus/content/repositories/snapshots']
default[:maven][:app_version] = '1.0-SNAPSHOT'
